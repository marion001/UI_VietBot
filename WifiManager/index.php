...
function deleteWifi(wifiName) {
  ...
  if (confirmDelete) {
    ...
    $.ajax({
      url: 'delete_wifi.php',
      type: 'POST',
      data: { action: 'delete_wifi', wifiName: wifiName },
      success: function(response) {
...
function passWifi(wifiName) {
  ...
  // Sử dụng hộp thoại xác nhận
    ...
    $.ajax({
      url: 'get_wifi_list.php',
      type: 'GET',
      data: { action: 'get_password', ssid: wifiName },
      success: function(response) {
...
function connectWWifiDaLUU(wifiName) {
  ...
  $.ajax({
    ...
    type: 'POST',
    data: { action: 'connect_wifi', wifiName: wifiName },
    success: function(response) {
  ...
  if (baomat === "") {
    ...
    if (confirmConnect) {
      ...
      $.ajax({
        url: 'connect_wifi.php',
        type: 'POST',
        data: { action: 'connect_and_save_wifi', ssid: ssid, password: password },
        success: function(response) {
      // Hủy bỏ thời gian chờ khi có phản hồi
      clearTimeout(timeout);
