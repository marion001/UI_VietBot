...
$favicon_path = '../assets/img/VietBot128.png';
                    ...
                    <div class="card-wrapper">
                            ...
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        <input type="hidden" value="admin" class="form-control" id="fm_usr" name="fm_usr" required autofocus>
                                    </div>
                                    <div class="mb-3">
                                        <label for="fm_pwd" class="pb-2"><h1>Trình Quản Lý File</h1></label>
                                        <input type="password" placeholder="Nhập Mật Khẩu" value="" class="form-control" id="fm_pwd" name="fm_pwd" required>
                                    </div>
                                    <div class="mb-3">
                                        <?php fm_show_message(); ?>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        <button type="submit" class="btn btn-danger btn-block w-100 mt-4" role="button">
                                            <?php echo lng('Login'); ?>
                                        </button>
                                    </div>
                                </form>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="table-responsive">
        <table class="table table-secondary table-bordered table-hover table-sm" id="main-table">
...
<head>
    ...
    <style>
        body.fm-login-page{ background-color:#dbe0c9;font-size:14px;}
        ...
        .message{ padding:4px 7px;border:1px solid #ddd;background-color:#c1c9a1b8}
        .message.ok{ border-color:green;color:green}
        .message.error{ border-color:red;color:red}
        .message.alert{ border-color:orange;color:orange}
        body.fm-login-page.theme-dark {background-color: #c1c9a1b8;}
        .theme-dark svg g, .theme-dark svg path {fill: #c1c9a1b8; }
    </style>
</head>
...
<head>
    <meta charset="utf-8">
    <?php if($favicon_path) { echo '<link rel="icon" href="'.fm_enc($favicon_path).'" type="image/png">'; } ?>
    <title>Trình Quản Lý File</title>
    <?php print_external('pre-jsdelivr'); ?>
