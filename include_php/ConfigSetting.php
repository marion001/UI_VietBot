...
if (isset($Web_UI_Login) && $Web_UI_Login === true) {
	if (!isset($_SESSION['root_id'])) {
		echo "<html><head><link rel='stylesheet' href='../assets/css/loading.css'><link rel='stylesheet' href='../assets/css/bootstrap.css'></head><body><br/><center><h1>Có Vẻ Như Bạn Chưa Đăng Nhập!<br/><br>
